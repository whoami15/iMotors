...
Route::group(['middleware' => 'revalidate'],function(){
    ...
    Route::get('/admin/loan/due', array('as' => 'get-admin-loan-due-history','uses' => 'Admin\AdminController@getAdminDueList'));
    Route::get('/admin/loan-due-history-data', array('as' => 'get-admin-loan-due-history-data','uses' => 'Admin\AdminController@getAdminDueListData'));
